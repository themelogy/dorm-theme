<div id="contact_form" class="mt-sm-30" style="max-width: 600px; margin: 0 auto;">
    ...
    <div class="form-row row">
        <div class="form group col">
            <button type="submit" class="btn btn-primary btn-4 font-weight-semibold text-0">{{ trans('global.buttons.send') }}</button>
        </div>

            ...
            <div class="modal-body">
                <div class="nav-tabs-custom">
                    <ul class="nav nav-tabs">
                        ...
                        <li><a href="#location" data-toggle="tab">Lokasyon</a></li>
                    </ul>
                    <div class="tab-content">
                        ...
                        <div class="tab-pane" id="gallery">
                            @php
                            $albums = app(\Modules\Gallery\Repositories\AlbumRepository::class)->all()->pluck('title', 'slug')->toArray();

                            @endphp
                            {!! Form::normalSelect("settings[album]", "Albüm", $errors, ['Seçiniz']+$albums, isset($page->settings->album) ? $page->settings->album : 0) !!}
                        </div>
                        <div class="tab-pane" id="location">
                            @php
                                $locations = app(\Modules\Location\Repositories\LocationRepository::class)->all()->pluck('name', 'slug')->toArray();
                            @endphp
                            {!! Form::normalSelect("settings[location]", "Albüm", $errors, ['Seçiniz']+$locations, isset($page->settings->location) ? $page->settings->location : 0) !!}
                        </div>
                    </div>
                 </div>
            </div>
